...
client = Mongo::Client.new(
  ['mydocumentdb-114743615542.us-east-1.docdb-elastic.amazonaws.com:27017'],
  database:'test',
  ssl: true
)
client = Mongo::Client.new('mongodb://docadmin:password@mydocumentdb-114743615542.us-east-1.docdb-elastic.amazonaws.com:27017')
db = client.database
collection = client[:people]
binding.pry
