...
aws s3 mb s3://glue-data-catalog-2018
...
```sh
aws s3 cp data/vehicle.csv s3://glue-data-catalog-2018/data/vehicle.csv
```
...
--targets '{"S3Targets": [{"Path": "s3://glue-data-catalog-2018/data/"}]}' \
--classifiers []
```